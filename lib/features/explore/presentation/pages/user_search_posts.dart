...
import '../../../posts/presentation/main_post.dart';
...
class UserSearchPostsPage extends StatefulWidget {
  const UserSearchPostsPage( {Key? key, required this.posts, required this.search}) : super(key: key);
...
class UserSearchPostAppBar extends StatelessWidget implements PreferredSizeWidget {
  ...
  Widget build(BuildContext context) {
    return AppBar(
      centerTitle: true,
      title: Text(title,style: AppStyles.styleSemiBold21.copyWith(fontSize: 18)),
